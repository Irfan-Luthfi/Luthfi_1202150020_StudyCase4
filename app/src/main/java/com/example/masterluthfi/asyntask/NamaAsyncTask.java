package com.example.masterluthfi.asyntask;
...
public class NamaAsyncTask extends AppCompatActivity {
    ...
    public String mahasiswa[] = new String[]{
            "MUHAMMAD IRFAN LUTHFI", "MUHAMMAD SUBHAN AL AZMI", "NURCAHYADI PERDANA", "MOH. AKBAR ANSHORY", "GINANJAR WIDYA PAMUNGKAS", "Bregas",
            "PRADIKA ADHEA GEVANI LAKSANA", "PRIMA POSMA RYAN", "JIMMY", "YOGA ADITAMA DIPAWIKARTA", "EPIFANIO JUANG VICTORIUS"
    };
